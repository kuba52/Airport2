...
namespace Conference.Data
{
    public sealed class FlightsService
    {
        ...
        public IReadOnlyList<Flight> GetTickets(int accId) =>
            _dbConnection.Query<Flight, Plane, Flight>(
                @"SELECT pa.flight_id AS arrivalId, f.start_time AS startTime, f.arrival_time AS arrivalTime, c.destination AS dest, c2.destination AS from, p.id as planeId, p.company AS comp
